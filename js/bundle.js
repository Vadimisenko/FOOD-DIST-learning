...
function slider ({container, slide, nextArrow, prevArrow, totalCounter,
     currentCounter, wrapper, field}) {
        ...
        sliderAll = document.querySelector(container),
  ...
  function dotOpasity() {
      dotarr.forEach(dot => dot.style.opacity = '0.5');
  ...
  dots.classList.add('carousele-indicators');
  dots.style.cssText = `
      position: absolute;
      right: 0;
      bottom: 0;
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__.default)('.timer', '2021-06-03');
